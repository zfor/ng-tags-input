...
angular.module("template/tagsinput.html", []).run(["$templateCache", function($templateCache) {
        $templateCache.put("template/tagsinput.html",
                ...
                "<span class='tag label' ng-class='{\"label-warning attention\": containsIndex === {{$index}}, \"blink\":containsIndex === $index, \"animate\":animations, \"label-danger\": deleteIndex === $index || selectAll,  \"label-primary\": ($parent.params.containsIndex !== $index && $parent.params.deleteIndex !== $index)}'>" +
                "<span class='tag-text'>{{tag}}</span>" +
                " <span class='glyphicon glyphicon-remove hover' ng-if='closeable' ng-click='removeTag(tag)'></span> " +
                "</span>" +
                "</span>&nbsp;" +
